								...
								<ul>
									<li>
										<span class="new-users-pic">
											<img src="uploads/graduated.png" alt=""/>
										</span>
										<span class="new-users-text">
											<a href="#" class="new-users-name"><?php echo ucwords($row['name']) ?> </a>
										</span>
									</li>
								</ul>
							</div>
	   ...
	   ?>
						...
						<div class="widget-inner">
							<div class="new-user-list">
								...
								<li>
										<span class="new-users-pic">
											<img src="uploads/teacher.png" alt=""/>
										</span>
										<span class="new-users-text">
											<a href="#" class="new-users-name"><?php echo ucwords($row['firstname']. "  " . $row['lastname']) ?> </a>
										</span>
									</li>
								</ul>
							</div>
