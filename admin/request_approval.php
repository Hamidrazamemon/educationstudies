	...
	<main class="ttr-wrapper">
		<div class="container-fluid">
			<div class="db-breadcrumb">
				<h4 class="breadcrumb-title"><strong>Request Approval</strong></h4>
			...
			<div class="row">
				...
				<div class="col-lg-12 m-b30">
					<div class="widget-box">
						<div class="wc-title">
							<h4><center>Request Approval</center></h4>
...
<table border="1" >
  ...
  <th>Teacher ID</th>
    ...
    <?php 
	   $query = "SELECT * from users where category='Teacher'";
  ...
  <td>". $row['user_id']."</td>
    ...
    <td>". $row['email']."</td>
    <td>". $row['subject']."</td>
	<td><button><a  href='teacher_approve.php?user_id=$row[user_id]&firstname=$data[firstname]&email=$data[email]&subject=$data[subject] '>Approve</a></button>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
	 <button><a  href='teacher_delete.php?user_id=$row[user_id]&firstname=$row[firstname]&email=$row[email]&subject=$row[subject]'>Reject</a></button></td>
  </tr>";} ?>
</table>
