					...
					<div class="col-lg-12">
							<div class="form-group">
								<div class="input-group">
									<input name="category" type="hidden" readonly value="Parents" required class="form-control">
								</div>
							</div>
						</div>
						<div class="col-lg-12">
						...
						<div class="col-lg-12">
							<div class="form-group">
								<div class="input-group">
									...
									<input name="student_id" type="text" required class="form-control">
								</div>
							</div>
						</div>
...
<?php
        if (isset($_POST['submit'])) {
            ...
            $run = mysqli_query($con, "INSERT INTO `parent`(`firstname`, `lastname`, `email`, `password`, `category`, `contact`, `student_id`) VALUES('$fname','$lname','$email','$password','$category','$contact',$student_id)");
            if ($run) {
                ?>
                <script>
