				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 text-center text-white">
							<h2>Education is the key of success</h2>
						...
						<div class="row">
							<div class="col-md-4 col-sm-6">
								<div class="cours-search-bx m-b30">
									<div class="icon-box">
										<h3><i class="ti-user"></i><span class="counter"><?php echo $con->query("SELECT * FROM student where category ='Student'")->num_rows; ?></span></h3>
									</div>
									<span class="cours-search-text">Over <?php echo $con->query("SELECT * FROM student where category ='Student'")->num_rows; ?> student</span>
								</div>
							</div>
							<div class="col-md-4 col-sm-6">
								<div class="cours-search-bx m-b30">
									<div class="icon-box">
										<h3><i class="ti-book"></i><span class="counter"><?php echo $con->query("SELECT * FROM users where category ='Teacher'")->num_rows; ?></span></h3>
									</div>
									<span class="cours-search-text">Over <?php echo $con->query("SELECT * FROM users where category ='Teacher'")->num_rows; ?> Teachers</span>
								</div>
							</div>
							<div class="col-md-4 col-sm-12">
								<div class="cours-search-bx m-b30">
									<div class="icon-box">
										<h3><i class="ti-layout-list-post"></i><span class="counter"><?php echo $con->query("SELECT * FROM study_notes")->num_rows; ?></span></h3>
									</div>
									<span class="cours-search-text"><?php echo $con->query("SELECT * FROM study_notes")->num_rows; ?> Resources</span>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="join-content-bx text-white">
								<h2>Education's purpose is to replace an empty mind<br></h2>
								<h4><span class="counter"><?php echo $con->query("SELECT * FROM study_notes")->num_rows; ?></span> Resources</h4>
								<p>Education is a process of learning through which we acquire knowledge. It enlightens, empowers, and creates a positive development. Education gives an individual the knowledge and skills to work with virtue. It aids the all-round mental, physical, and intellectual growth and development of an individual</p>
