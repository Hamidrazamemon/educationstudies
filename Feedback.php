...
{
	echo"<script>Feedback Has Been Sent</script>";
}
else{
	echo"<script>Feedback Sending Failed</script>";
	}
                ...
                <div class="row">
					<div class="col-lg-5 col-md-5 m-b30">
						<div class="bg-primary text-white contact-info-bx">
							<h2 class="m-b10 title-head">Feedback <span>us</span></h2>
					...
					<div class="col-lg-7 col-md-7">
						<form class="contact-bx " method="POST">
							<div class="heading-bx left">
								<h2 class="title-head">Give your  <span>Feedback to us!</span></h2>
							...
							<div class="row placeani">
								...
								<div class="col-lg-12">
									<button name="btnsubmit" type="submit" value="Submit" class="btn button-md"> Send Message</button>
								</div>
							</div>
						</form>
					</div>
